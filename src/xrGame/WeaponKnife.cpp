...
void CWeaponKnife::OnAnimationEnd(u32 state)
{
    ...
    case eFire2:
    {
        ...
        if (attackStarted)
        {
            ...
            if (state == eFire)
                time = PlayHUDMotion("anm_attack_end", "anim_shoot1_end", EHudMixType::eNoMix, state);
            else // eFire2
                time = PlayHUDMotion("anm_attack2_end", "anim_shoot2_end", EHudMixType::eNoMix, state);
...
void CWeaponKnife::switch2_Attacking(u32 state)
{
	if (state == eFire)
	{
		...
		PlayHUDMotion("anm_attack", "anim_shoot1_start", EHudMixType::eNoMix, state);
	...
	else
	{
		...
		PlayHUDMotion("anm_attack2", "anim_shoot2_start", EHudMixType::eNoMix, state);
...
void CWeaponKnife::switch2_Hiding	()
{
	...
	PlayHUDMotion("anm_hide", "anim_hide", EHudMixType::eMixAll, GetState());
...
void CWeaponKnife::switch2_Showing	()
{
	...
	PlayHUDMotion("anm_show", "anim_draw", EHudMixType::eNoMix, GetState());
