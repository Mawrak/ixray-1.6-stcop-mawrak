...
{
	PlayHUDMotion(HudAnimationExist("anm_switch") ? SetCurrentStateAnimation("anm_switch") : m_bGrenadeMode ? "anim_switch_grenade_on" : "anim_switch_grenade_off", EHudMixType::eMixAll, eSwitch);
}
